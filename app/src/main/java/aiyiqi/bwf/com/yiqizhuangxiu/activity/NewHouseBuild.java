 ...
 */
public class NewHouseBuild extends BaseActivity {
    @BindView(R.id.title)
    TextView title;
    @BindView(R.id.back)
    ImageView back;
    ...
    protected void initViews() {
        ...
        newandoldWebview.loadUrl("http://hui.17house.com/svc/payment-facade/h5/activity677/index.html?model=android");
    }
